...
class RenderRegBlockModel extends React.Component {
        ...
        <>
            ...
            <Modal.Body>
                <Form>
                    <Form.Group as={Row} controlId="basicshape-selector">
                        ...
                        <Col sm="8">
                            <Form.Control defaultValue={this.state.basicshape} as="select">
                                <option>Rectangular Block</option>
                            </Form.Control>
                        </Col>
                    </Form.Group>
                    <Form.Group as={Row} controlId="regmodal-basicshape-name">
                        ...
                        <Col sm="9">
                            <Form.Control
                                ...
                                type='text'
                                value={this.state.shapename}
                            />
                        </Col>
                    </Form.Group>
                    <Form.Group as={Row} controlId="regmodal-x-input">
                        <Form.Label column sm="3">
                        Length
                        </Form.Label>
                        <Col sm="4">
                    ...
                    <Form.Group as={Row} controlId="regmodal-y-input">
                        <Form.Label column sm="3">
                        Breadth
                        </Form.Label>
                        <Col sm="4">
                    ...
                    <Form.Group as={Row} controlId="regmodal-z-input">
                        <Form.Label column sm="3">
                        Height
                        </Form.Label>
                        <Col sm="4">
...
export default RenderRegBlockModel;